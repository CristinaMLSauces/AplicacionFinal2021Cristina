...
USE DAW207DBLoginLogoffPOOMulticapa;
...
INSERT INTO T02_Departamento(T02_CodDepartamento, T02_DescDepartamento, T02_FechaCreacionDepartamento, T02_VolumenNegocio) VALUES
    ('INF', 'Departamento de informatica',1618418339, 5),
    ('VEN', 'Departamento de ventas',1618418339, 8),
    ('CON', 'Departamento de contabilidad',1618418339, 9),
    ('MAT', 'Departamento de matematicas',1618418339, 8),
    ('MKT', 'Departamento de marketing',1618418339, 1);

-- 1618418339 -> 14-abr-2021 ~16:38:59 --
